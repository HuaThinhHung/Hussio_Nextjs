  ...
  return (
    <div className="bg-white min-h-screen">
      <div className="container mx-auto px-4 py-10 md:py-20 animate-fade-in">
        <h1 className="text-2xl md:text-4xl font-black tracking-tight uppercase mb-2 text-center">
          GIỎ HÀNG CỦA BẠN
        </h1>
        ...
        {loading ? (
          ...
          <div className="max-w-md mx-auto text-center py-20">
            ...
            <h2 className="text-lg font-semibold tracking-widest uppercase mb-4">
              GIỎ HÀNG TRỐNG
            </h2>
            <p className="text-zinc-500 text-sm mb-10 leading-relaxed italic">
              Vui lòng quay lại cửa hàng để chọn sản phẩm bạn yêu thích.
            </p>
            <Link
              href="/products"
              className="inline-block bg-black text-white px-10 py-4 text-[10px] font-semibold tracking-widest uppercase hover:bg-zinc-800 transition-all"
            >
              BẮT ĐẦU MUA SẮM
            </Link>
          </div>
