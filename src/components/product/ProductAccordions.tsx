...
const ProductAccordions = ({ descriptionHtml, warranty }: ProductAccordionsProps) => {
  const warrantyText = warranty || 'DỊCH VỤ BẢO HÀNH 1 ĐỔI 1 (THEO CHÍNH SÁCH CỬA HÀNG).';
  ...
  return (
    <div className="pt-8 space-y-6">
      <details className="group border-b border-zinc-200 pb-4" open>
        ...
        {descriptionHtml ? (
          <div
            className="mt-4 text-[11px] leading-relaxed text-zinc-600 tracking-wide"
      ...
      <details className="group border-b border-zinc-200 pb-4">
        <summary className="list-none flex justify-between items-center cursor-pointer">
          <span className="text-[10px] font-semibold tracking-widest uppercase">BẢO HÀNH</span>
          <span className="group-open:rotate-180 transition-transform">▼</span>
        </summary>
        <div className="mt-4 text-[11px] leading-relaxed text-zinc-600 tracking-wide uppercase">
          {warrantyText}
