...
const CartSummary = ({ subtotal, checkoutUrl }: CartSummaryProps) => {
  ...
  return (
    <div className="lg:col-span-4">
      <div className="bg-zinc-50 p-8 space-y-6 sticky top-24 border border-zinc-200">
        ...
        <Link
          href="/products"
          className="block text-center text-[10px] font-semibold underline tracking-widest uppercase hover:opacity-70 transition-opacity"
        >
          TIẾP TỤC MUA SẮM
        </Link>
      </div>
